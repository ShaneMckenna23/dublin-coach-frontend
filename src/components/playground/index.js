...
export default ({match}) => (
  <div>
    ...
    <ul>
      ...
      <li><Link to={`${match.url}/page/about`}>About</Link></li>
      <li><Link to={`${match.url}/page/contact`}>Contact</Link></li>
      <li><Link to={`${match.url}/old/path`}>Redirect from /old/path &#8594; /new/path</Link></li>
    </ul>
    <hr />
    <Switch>
      <Route exact path="/playground" component={Home} />
      <Route path={`${match.url}/page/:name`} component={Page}/>
      <Redirect from={`${match.url}/old/path`} to={`${match.url}/new/path`} />
